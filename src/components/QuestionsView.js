...
const fetchData = async () =>{
  ...
  // const nextURL = 'http://'+splits[2]+"/"+splits[3]+"/"+primary+"/"+splits[4]+"/QuestionView"
    ...
    const url = "http://mathematix.duckdns.org:5000/getQuestion?username="+splits[3]+"&unitName="+ splits[4]+ "&className=" + splits[5] + "&qnum=" + splits[6]
...
export default function QuestionView() {
  ...
  ,
  {
    ...
    const fetchData2 = async (primary) =>{
      ...
      const thisURL = window.location.href;
      const splits = thisURL.split('/')
      const url = "http://mathematix.duckdns.org:5000/startUnit?className="+splits[5]+"&username="+splits[3]+"&unitName="+primary
      const result = await fetch(url)      
      const jsonResult = await result.json();
      ...
      async function quit(){
        const url = "http://mathematix.duckdns.org:5000/quitActiveUnit?username="+splits[3]+"&unitName="+ splits[4]+ "&className=" + splits[5]
      ...
      async function submitSingle(qans,id){
        ...
        const thisURL = window.location.href;
        const splits = thisURL.split('/')
        const url = "http://mathematix.duckdns.org:5000/submitQuestion?username="+splits[3]+"&unitName="+ splits[4]+ "&className=" + splits[5]+
        ...
        if(promise.status ===200){
          ...
          //http://mathematix.duckdns.org:3000/dan/math2/math2/1/QuestionView
          //http://mathematix.duckdns.org:3000/dan/math2/studentClassUnits
