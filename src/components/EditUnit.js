...
const EditUnit = () => {
  ...
  const url = "http://87.71.64.163:5000/getUnitDetails?unitName="+splits[5]+"&className="+splits[4]
  fetchDataCall(url)
  },[]);


  const url = "http://87.71.64.163:5000/getUnitDetails?teacher="+splits[3]+"&unitName="+splits[5]+"&className="+splits[4]
  console.log(url)
  ...
  const handleNext = async () => {
    ...
    if((name.length>0 && desc.length>0)){
      const url = "http://87.71.64.163:5000/editUnit?unitName="+splits[5]+
