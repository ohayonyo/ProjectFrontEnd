  ...
  return (
    ...
    <div className='background5'>
      ...
      <div >
          ...
          {/* Header */}
        <div  style={{textAlign:'center',marginRight:'10%',marginTop:'4%'}}>
          ...
          <div style={{fontWeight:'bold',fontSize:20,textAlign:'right', marginRight:'10%'}}>
            ...
            {<br></br>}
            תשובה : בכדי להשלים יחידת לימוד בהצלחה, יש לענות נכונה ברצף על כמות השאלות אותה הגדיר המורה שפתח את יחידת הלימוד
            .כמות שאלות זו מופיעה בראש יחידת הלימוד כאשר פותרים אותה. בכדי לענות בהצלחה על יחידת לימוד מורכבת 
            {<br></br>}
            תנאי זה חייב להתקיים עבור כל יחידת לימוד בנפרד     
            {<br></br>}
            {<br></br>}
             ?שאלה : כמה פעמים ניתן לפתור יחידת לימוד
            {<br></br>}
            .תשובה : ניתן לפתור יחידת ללא הגבלה בתנאי שתאריך ההגשה של יחידת הלימוד לא הסתיים 
            {<br></br>}
            {<br></br>}
             ?שאלה :מה ההבדל בין יחידת לימוד פשוטה ליחידת לימוד מורכבת 
            {<br></br>}
