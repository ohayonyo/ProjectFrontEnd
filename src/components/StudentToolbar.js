       ...
       <nav class="w3-sidebar toolbar_background w3-collapse w3-top w3-large w3-padding style1" style={{position:'fixed',right:0,top:0,width:'15%'}} id="mySidebar">
        ...
        <div style={{textAlign:'center'}}>
          ...
          <div class="w3-bar-block" style={{fontSize:'20px',marginTop:'-10%'}}>
            ...
            <a href="/studentsRequestToClass" onClick={()=>w3_close('btn4')} class="w3-bar-item w3-button hover-resize w3-click-white" id="btn4" style={style_clickable_options}><p style={style_menu_labels}>להשלים</p></a> 
            <a href="/studentsRequestToClass" onClick={()=>w3_close('btn5')} class="w3-bar-item w3-button hover-resize w3-click-white" id="btn5" style={style_clickable_options}><p style={style_menu_labels}>להשלים</p></a> 
          </div>
        </div>
